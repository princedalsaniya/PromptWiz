...
/*
  ...
  route     : -
  requires  : signIn = login user
              signOut = logout user
              useSession = get the current session
              getProviders = get the googleProvider and set inside the providers for signIn
                             So when we call signIn it will use the googleProvider
  exports   : Nav
